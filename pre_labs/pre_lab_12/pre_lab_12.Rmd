...
**Task** Run the following code and describe the dataframe it outputs. **Answer** A lot of them seem to be donations to different organizations
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** It helps R create a character vector with the listed elements 
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** It removed punctuation, converted text to lowercase, and handles tokenization. As a result, the dataframe now has one word per row under the word column
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** It doesn't really show anything because it shows generic words like "the" and "and"
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** Yes, I think its interesting that health, support and fundraising are at the top
...
**Task** Run the following code and describe the results. **Answer** The top ten words revolve around community and fundraising
...
**Task** Run the following code and describe the results. **Answer** It includes phrases now and more than one word
...
**Task** Run the following code and describe the results. **Answer** health care and chesapeke bay are still at the top
...
Stemming might be useful for faster processing in cases where precision is less important 
```{r}
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **Answer** I think lemmatization is still more useful 
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** I think generally most sentiments are correct, but I don't think it really adds anything interesting
