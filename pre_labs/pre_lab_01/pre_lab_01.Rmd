...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **Answer**<chr> <dbl>
The last name column represents the last name of the doners and the amount is the different amounts donated
...
**Answer**It is grouping the data by date and counting the amount of contributions made on that date
...
**Answer** It is not in descending order, having the amount of contributions at the highest number
...
**Answer** We can now see the memo text and the amount of times a certain amount of money was donated 
...
**Answer**Within that memo text, we can see how many people contributed in that name and the total amount of money donated for that memo
...
**Answer** Trump National Committee 41835
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer**Annapolis (?)
