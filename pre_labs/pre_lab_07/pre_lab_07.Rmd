...
```{r echo=FALSE}
census_api_key("e369fcda419fe9ae1d0c28b51a3573cfe44942e9", install=TRUE)
```
...
Is the difference between Calvert and Montgomery significant? **Answer** No because the two bars overlap so it is within the margin of error

Is the difference between Howard and everyone else significant? **Answer** Yes because it looks like an outlier
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** I am confused on what each column means. I also do not know if I did the previous quesiton correctly.
