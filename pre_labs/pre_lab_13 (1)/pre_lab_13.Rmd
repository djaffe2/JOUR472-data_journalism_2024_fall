...
detach_all_packages <- function() {
  ...
  # Detach all except the basic packages
  for (pkg in setdiff(loaded_packages, basic_packages)) {
    detach(pkg, character.only = TRUE, unload = TRUE)
  }
}

# Run the function to detach all loaded packages
detach_all_packages()
```
...
```{r}
create_credentials(GROQ_API_KEY = "e369fcda419fe9ae1d0c28b51a3573cfe44942e9")
```
