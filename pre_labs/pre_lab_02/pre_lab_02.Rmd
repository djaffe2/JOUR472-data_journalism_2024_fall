...
**Answer** It is taking the data and filtering it with the columns you want to see. We can also look at the percentage from election day and votes
...
**Answer** It doesn't really change much about what we have already seen from the table
...
**Answer** str_to_lower, str_to_sentence, str_to_title 
