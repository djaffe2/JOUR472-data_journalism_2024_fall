...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer** 19 columns, 24 rows
...
**Answer** This code used mutate to create a new column with the difference between 2022 and 2024 unaffiliated voters. It then created a new data frame in descending order with just the county and unaf difference. It selected the county column, the unaffiliated difference column and the top 10 counties
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**The blank canvas that will contain the chart
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A bar chart with the counties on the x-axis and the amount of unaffiliated voters on the y-axis
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer**It is in order from least to most unaf voters
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The axis switched so the counties are on the y axis. The names also are not overlapping
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The grey in the back disappeared 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer**The background is a light blue and there are white lines
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The x and y axis have names, there is a title and a source. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** How many total contirbutions were made on that specific day
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** A line chart representing the patterns in how many contributions were made from April-July
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** The x axis has more dates 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Rather than having the dates be close to each other, it turned 45 degrees so there is more space between each date 
