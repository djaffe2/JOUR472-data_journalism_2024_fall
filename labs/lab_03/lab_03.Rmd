...
md_contribs |>
  ...
  arrange (desc(contributions=n()))

#arrange (desc(contributions))
#bethesda, chevy chase, baltimore, annapolis, potomac, silver spring, rockville, ellicot city, columbia, takoma park
...
A3:The top doners are from cities that had the most contributions/ are from wealthy cities in Maryland
