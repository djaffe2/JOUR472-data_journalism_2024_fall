...
```{r}
# Changes
changes<- read.csv('party_affil.csv')|>
...
```{r}
current_reg_2022<- current_reg_2022|>
...
```{r}
 current_reg_2024<- current_reg_2024|>
...
```{r}
pct_change_unaf <- current_reg_2024 |>
select (COUNTY,pct_unaf_2024) |>
...
A5. Are the new politicians that have been running for president turnign the Americans away from wanting to vote?
