...
Answer: Counties with more eligible voters tend to have higher early voting turnout. Demographics like income, unemployment, and party affiliation also explain differences between counties.
```{r}
md_data_2 <- get_acs(
  geography = "county",
  variables = c(
